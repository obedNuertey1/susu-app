      ...
      <div className='flex justify-center items-center h-screen'>
        <div className='max-w-md m-auto w-10/12 border items-center border-back p-3 flex flex-col gap-4 '>
            ...
            <form className='w-full'>
              <InputField ref={warnRef2} inputText={setUsername} inputTextValue={username} inputTypeValue='text' labelText='Username:' />
              <InputField ref={warnRef} inputText={setPassword} inputTextValue={password} inputTypeValue='password' labelText='Password:' />
            ...
            <p><span><Link className='text-right text-blue-900 hover:decoration-blue-700' href={"/register"}>Register instead?</Link></span></p>
          </div>
      </div>
    </>
  )
