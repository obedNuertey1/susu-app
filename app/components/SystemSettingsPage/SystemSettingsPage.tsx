...
// 
  ...
  return (
    <div>
        {
            successMessage &&
            <div role="alert" className={`alert alert-success fixed left-0 z-50 right-0 top-[0vh] w-[90vw] justify-self-center self-center gap-1 flex-row mx-auto -translate-y-[100%] ${styles.promptAnime}`}>
